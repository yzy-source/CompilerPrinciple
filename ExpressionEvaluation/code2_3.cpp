...
/****************************************************************************
* code2_3.cpp
* C++ source file generated from code2_3.y.
* 
* Date: 11/01/16
* Time: 21:54:52
* 
	...
	case 7:
		{
			...
			{
#line 84 ".\\code2_3.y"
int decpt,sign;char *ptr;ptr=fcvt(yylval,0,&decpt,&sign);(*(YYSTYPE YYFAR*)yyvalptr)=ptr;
#line 297 "code2_3.cpp"
			}
		}
		break;
	default:
